...
\section{Educação}
  \resumeHeadingListStart{}
    ...
    {Engenharia de Computação e Informação}{Mai 2021 -- Jun 2026 (Previsão)}
...
\section{Projetos}
  \resumeHeadingListStart{}
    ...
    \resumeTrioHeading{Finance}{Python, OOP, SQLite3, Git}{\href{https://github.com/mhscardoso/finance}{\uline{Código Fonte}}}
      \resumeItemListStart{}
        \resumeItem{Aplicação Python para desktop para simulação de compra e venda de ações.}
        \resumeItem{Trabalhei diretamente com \textbf{Queries SQL}}
        \resumeItem{Trabalhei com conceitos de \textbf{Orientação a Objetos}}
      \resumeItemListEnd{}
