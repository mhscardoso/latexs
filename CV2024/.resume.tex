...
\section{Profile}
\small{
    I'm a programmer with over \textbf{1 year experience in Python} and over \textbf{6 month experience 
    in TypeScript} working with popular frameworks such as \textbf{Flask, Django, FastAPI, NestJS and NextJS}. 
    I also have experience with \textbf{Docker} containerizing applications to run in the cloud.

    I also have the \textbf{ability to learn development tools, habit of reading APIs, frameworks and 
...
\section{Technical Skills}
  \resumeHeadingListStart{}
    ...
    \resumeSectionType{Frameworks}{:}{Flask, Django, FastAPI, NestJS, NextJS}
...
\resumeHeadingListStart{}
  ...
  \resumeQuadHeading{Developer Intern / Data Intelligence}{Mai 2024 -- Now}
